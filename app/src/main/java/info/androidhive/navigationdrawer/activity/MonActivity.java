...
public class MonActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseevents = FirebaseDatabase.getInstance().getReference("events/monday/sno");
    ...
    private void deleteArtist(String eventId) {
        ...
        DatabaseReference drEvent = FirebaseDatabase.getInstance().getReference("events/monday/sno").child(eventId);
    ...
    protected void onStart() {
        ...
        databaseevents.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                EventList adapter = new EventList(MonActivity.this,events);
    ...
    private void add(){
        ...
        if (!TextUtils.isEmpty(programme) && !TextUtils.isEmpty(time) && !TextUtils.isEmpty(venue))
        {
            ...
            demoRef.child("monday/date").setValue(date);
