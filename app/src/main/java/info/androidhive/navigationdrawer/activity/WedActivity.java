...
public class WedActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseevents = FirebaseDatabase.getInstance().getReference("events/wednesday/sno");
    ...
    private void deleteArtist(String eventId) {
        ...
        DatabaseReference drEvent = FirebaseDatabase.getInstance().getReference("events/wednesday/sno").child(eventId);
    ...
    protected void onStart() {
        ...
        databaseevents.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                EventList adapter = new EventList(WedActivity.this,events);
    ...
    private void add(){
        ...
        if (!TextUtils.isEmpty(programme) && !TextUtils.isEmpty(time) && !TextUtils.isEmpty(venue))
        {
            ...
            demoRef.child("wednesday/date").setValue(date);
